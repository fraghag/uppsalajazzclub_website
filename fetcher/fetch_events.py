...
@app.command()
def main(
    since: Optional[str] = typer.Option(None, "--since", help="Fetch historical events since this date (YYYY-MM-DD)"),
):
    """
    ...
    if since:
        ...
        typer.echo("Fetching upcoming events...")
    ...
    try:
        ...
        if e.response.status_code == 400:
            typer.echo("Error: Facebook API returned a 400 Bad Request.", err=True)
